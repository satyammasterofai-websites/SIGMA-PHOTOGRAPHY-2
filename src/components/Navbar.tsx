...
export default function Navbar() {
  ...
  const bgGradient =
    navbar?.bgGradient || "from-pink-700 via-rose-600 to-pink-700";
  const transparency =
    navbar?.transparency !== undefined ? navbar.transparency : 80;
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between relative z-10">
          ...
          >
            ...
            <span
              className={`font-display font-bold text-2xl tracking-tighter ${logoColor}`}
            >
              SIGMA
              <span
                className={
                  isLogoTextNavy
                    ? "text-brand-purple font-light"
                    : "font-light ml-1"
                }
              >
                PHOTOGRAPHY
