...
export default function SiteContentManagement() {
  ...
  const [navbar, setNavbar] = useState({
    ...
    logoColor:
      "bg-gradient-to-r from-pink-100 via-white to-pink-200 bg-clip-text text-transparent",
  });
    ...
    <div className="w-full">
      <div className="mb-8">
        ...
        <p className="text-brand-slate mt-1">
          Manage all public-facing website content in real-time.
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="lg:w-64 flex flex-col gap-2">
          {["logo", "hero", "navbar", "contact", "about", "features"].map(
            (tab) => (
              <button
                key={tab}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="flex gap-4 mt-6">
                    <button
                      onClick={saveLogo}
                      className="flex-1 flex items-center justify-center gap-2 bg-indigo-500 hover:bg-indigo-600 text-white py-3 rounded-xl font-medium transition-colors"
                    >
                      <Save className="w-4 h-4" /> Save Logo
                    </button>
                    <button
                      onClick={deleteLogo}
                      className="flex items-center justify-center gap-2 bg-red-500/10 hover:bg-red-500/20 text-red-500 px-6 py-3 rounded-xl font-medium transition-colors"
                    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      type="text"
                      value={navbar.bgGradient}
                      onChange={(e) =>
                        handleNavbarChange({ bgGradient: e.target.value })
                      }
                      className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-2"
                      placeholder="e.g. from-[#FFF0F5] to-[#FFC0CB]"
                    />
                    <p className="text-xs text-gray-400 mt-1">
                      Default: from-pink-700 via-rose-600 to-pink-700
                    </p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleNavbarChange({
                          transparency: parseInt(e.target.value) || 80,
                        })
                      }
                      className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-2"
                    />
                    <p className="text-xs text-gray-400 mt-1">
                      Example: 80 for 80% opacity when scrolled
                    </p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleNavbarChange({ textColor: e.target.value })
                      }
                      className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-2"
                      placeholder="e.g. text-brand-navy"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-2">
                      Logo Text Color (Tailwind Class)
                    </label>
                    <input
                      type="text"
                      value={navbar.logoColor}
                      onChange={(e) =>
                        handleNavbarChange({ logoColor: e.target.value })
                      }
                      className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-2"
                      placeholder="e.g. text-brand-navy"
                    />
                  ...
                  <button
                    onClick={saveNavbar}
                    className="w-full flex items-center justify-center gap-2 bg-indigo-500 hover:bg-indigo-600 text-white py-3 rounded-xl font-medium transition-colors mt-6"
                  >
                ...
                <div>
                  ...
                  <div className="w-full h-48 rounded-xl border border-gray-800 bg-gray-100 flex p-6 relative overflow-hidden items-start justify-center">
                    ...
                    >
                      <span className={`font-bold ${navbar.logoColor}`}>
                        SIGMA
                      </span>
                      <div
                        className={`hidden md:flex gap-4 text-sm ${navbar.textColor}`}
                      >
                        <span>Home</span>
                        <span>Templates</span>
                        <span>Contact</span>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      value={hero.heading}
                      onChange={(e) =>
                        setHero({ ...hero, heading: e.target.value })
                      }
                      className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-2"
                    />
                  </div>
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-2 resize-none"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-2">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-2">
                      Video URL (YouTube/Vimeo preview)
                    </label>
                    <input
                      type="url"
                      value={hero.videoUrl}
                  ...
                  <button
                    onClick={saveHero}
                    className="w-full flex items-center justify-center gap-2 bg-indigo-500 hover:bg-indigo-600 text-white py-3 rounded-xl font-medium transition-colors mt-4"
                  >
                  ...
                  <div className="w-full h-[600px] rounded-xl border border-gray-800 overflow-hidden relative shadow-inner bg-white">
                    ...
                    <div className="p-6 relative z-10 flex flex-col h-full">
                      ...
                      <p className="mt-4 text-gray-600 text-sm max-w-sm">
                        {hero.subheading ||
                          "Your subheading will appear here giving context to your brand."}
                      </p>
                      <div className="mt-6">
                        <button className="bg-gray-900 text-white px-6 py-2 rounded-full text-sm">
                          {hero.buttonText || "Call to Action"}
                        </button>
                      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setContact({ ...contact, office: e.target.value })
                    }
                    className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-2"
                  />
                </div>
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setContact({ ...contact, mapUrl: e.target.value })
                    }
                    className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-2"
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    type="text"
                    value={contact.otherLinks}
                    onChange={(e) =>
                      setContact({ ...contact, otherLinks: e.target.value })
                    }
                    className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-2"
                  />
                </div>
                <div className="md:col-span-2 mt-4">
                  <button
                    onClick={saveContact}
                    className="w-full md:w-auto px-8 flex items-center justify-center gap-2 bg-indigo-500 hover:bg-indigo-600 text-white py-3 rounded-xl font-medium transition-colors"
                  >
                ...
                <div>
                  ...
                  <div className="w-full rounded-xl border border-gray-800 bg-white p-6 shadow-sm">
                    ...
                    <p className="text-gray-600 text-sm whitespace-pre-wrap">
                      {about.description || "Description preview..."}
                    </p>
                  </div>
                </div>
              </div>
          ...
          {activeTab === "features" && (
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 shadow-sm">
              <div className="flex justify-between items-center mb-6 border-b border-gray-800 pb-4">
                ...
                <button
                  onClick={addFeature}
                  className="bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 rounded-xl font-medium transition-colors text-sm flex items-center gap-2"
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateFeature(index, "number", e.target.value)
                          }
                          placeholder="01"
